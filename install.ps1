param(
    [string]$ExtensionName = "Chrome Home Extension",
    [string]$RepoName = "Chrome-New-Tab-Extension"
)
...
try {
  ...
  $robocopyArgs = @(
    ...
    '/XF', '*.log', 'install.bat', 'install.ps1', 'publish-to-github.bat', 'publish-to-github.ps1'
  )
